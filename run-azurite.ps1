...
docker run -p 127.0.0.1:10000:10000 -p 127.0.0.1:10001:10001 -p 127.0.0.1:10002:10002  --mount "type=bind,source=$localDataFolderName,target=/data" mcr.microsoft.com/azure-storage/azurite
